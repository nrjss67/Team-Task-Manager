...
class Task(models.Model):
    ...
    priority = models.CharField(
        max_length=10, choices=PriorityChoices, default=PriorityChoices.LOW
    )
...
class MessageNew(models.Model):
    from_worker = models.ForeignKey(
        Worker, on_delete=models.CASCADE, related_name="from_worker"
    )
    to_worker = models.ForeignKey(
        Worker, on_delete=models.CASCADE, related_name="to_worker"
    )
